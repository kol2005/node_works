...
ES5 이하에서js파일을 외부에 분리하고
실제 사용할때는 import 사용하는 방식

ES6 이상에서는 import 키워드로 사용이 되는데
아직 node12버전 이하에서는 import 키워드를 지원하지 않는다

node14버전 이상에서는 import 키워드를 공식으로 지원한다

require() 를 사용해서 import를 할때
require("./routes"); // routes 폴더(dir)를 지정하는 방법
 지정한 위치에서 routes.js 파일을 찾고
 파일이 없으면 routes/index.js를 찾는다
...
// router/Photo/index.js를 import 하라
